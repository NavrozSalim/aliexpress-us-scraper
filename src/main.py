"""Apify Actor entry — Seller Pilot — AliExpress US Scraper (production scraper)."""
...
from scrapers.aliexpress_scraper import scrape_aliexpress as _scrape
...
async def main() -> None:
    async with Actor:
        ...
        Actor.log.info("Scraping vendor=aliexpressus region=%s url=%s", region, url[:120])
        try:
        ...
        result = normalize_result(raw, vendor="aliexpressus", region=region, url=url)
